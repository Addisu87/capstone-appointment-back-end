class Api::V1::MotorcyclesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @motorcycle.save
        format.html { redirect_to api_v1_motorcycles(@motorcycle), notice: 'Motorcycle was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @motorcycle.update(motorcycle_params)
        format.html { redirect_to api_v1_motorcycle(@motorcycle), notice: 'Motorcycle was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to api_v1_motorcycle, notice: 'Motorcycle was successfully destroyed.' }
